...
1.times do
  ...
  #1  TipoActividad.create(nombre: "LogIn", descripcion: "Inicio de sesión en la aplicacion")
  #2  TipoActividad.create(nombre: "LogOut", descripcion: "Finalizar sesión en la aplicacion")
  #3  TipoActividad.create(nombre: "Jugar", descripcion: "Empieza un nuevo juego")
  #4  TipoActividad.create(nombre: "Inicio Leccion", descripcion: "Inicia una nueva repeticion de una leccion")
  #5  TipoActividad.create(nombre: "Crear entrada", descripcion: "Crea una nueva entrada para el foro")
  #6  TipoActividad.create(nombre: "Publicar entrada", descripcion: "Publica una entrada previamente creada")
  #7**  TipoActividad.create(nombre: "Ver Estudiante", descripcion: "Revisa los datos relacionados a un estudiante")
  #8  TipoActividad.create(nombre: "Dictar programa", descripcion: "Crea una relacion Docente-Programa")
  #9  TipoActividad.create(nombre: "Crear aula", descripcion: "Crea una nueva aula para los estudiantes")
  #10 TipoActividad.create(nombre: "Inscribir estudiante", descripcion: "Inscribe un estudiante a un aula creada")
  #11 TipoActividad.create(nombre: "Eliminar estudiante", descripcion: "Elimina a un estudiante de un aula a la que esta inscrito")
  #12 TipoActividad.create(nombre: "Eliminar Aula", descripcion: "Elimina un aula existente")
  #13 TipoActividad.create(nombre: "Asociar Archivo", descripcion: "Crea una relacion Archivo-Juego")
  #14 TipoActividad.create(nombre: "Disociar Archivo", descripcion: "Elimina una relacion Archivo-Juego")
  #15 TipoActividad.create(nombre: "Crear Archivo", descripcion: "Crea un nuevo registro de archivo")
  #16 TipoActividad.create(nombre: "Elimnar archivo", descripcion: "Elimina un registro de archivo")
  #17 TipoActividad.create(nombre: "Modificar aula", descripcion: "Modifica el nombre o la descripcion de un aula especifica")
  #18 TipoActividad.create(nombre: "Eliminar Docente Programa", descripcion: "Elimina una relacion Docente-Programa")
  #19 TipoActividad.create(nombre: "", descripcion: "")
  #20 TipoActividad.create(nombre: "", descripcion: "")
  #21 TipoActividad.create(nombre: "", descripcion: "")
  #22 TipoActividad.create(nombre: "", descripcion: "")
  #23 TipoActividad.create(nombre: "", descripcion: "")
  #24 TipoActividad.create(nombre: "", descripcion: "")
  #25 TipoActividad.create(nombre: "", descripcion: "")
